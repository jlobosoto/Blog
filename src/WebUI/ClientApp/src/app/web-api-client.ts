...
export interface IPostsClient {
    ...
    delete(id: number): Observable<FileResponse>;
    approve(id: number | undefined, command: ApprovePostsCommand): Observable<FileResponse>;
    reject(id: number | undefined, command: RejectPostsCommand): Observable<FileResponse>;
}
